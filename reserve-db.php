...
$q1=$con->query("SELECT * FROM  reservation");
?>
...
<body style="background-color:yellow;">
  ...
  <center> <h2>Reservation Details</h2> <div id="header" style="height:20px;width:40%"></center>
...
<div id="templatemo_main">
  <center><table width="913" height="38" border="1">
    <tr>
      ...
      <th width="70" scope="col">Time</th>
       <th width="102" scope="col">Person</th>
    </tr>
    <?php 
