...
<div class="container">
  <form action="payform-db.php" method="POST">
    ...
    <select id="items" name="item">
      <option value="Staberry Flavour Wine">Staberry Flavour Wine</option>
      <option value="Orange Flavour Wine">Orange Flavour Wine</option>
      <option value="Grapes Wine">Grapes Wine</option>
      <option value="Black Label">Black Label</option>
      <option value="grapes falavour wine">grapes falavour wine</option>
      <option value="Black wine">Black Wine</option>
       <option value="Apple Wine">Apple Wine</option>
        <option value="Pomegratte Wine">Pomegratte Wine</option>
    </select>
