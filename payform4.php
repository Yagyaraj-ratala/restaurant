...
<div class="container">
  <form action="payform-db.php" method="POST">
    ...
    <select id="items" name="item">
      <option value="Strawberry flavour Wine">Strawberry flavour Wine</option>
      <option value="Cup Icecream<">Icecream</option>
      <option value="Chockalete cake">Chockalete cake</option>
      <option value="Butter IceCream">Butter Icecream</option>
      <option value="Milky Ice cream">Milly Ice cream</option>
