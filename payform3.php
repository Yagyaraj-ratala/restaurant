...
<div class="container">
  <form action="payform-db.php" method="POST">
    ...
    <select id="items" name="item">
      ...
      <option value="Tandori Roti">Tandori Roti</option>
      <option value="Chicken Chilly">Chicken Burger Chilly</option>
      <option value="Special Chicken Noodles">Special Chicken Noodles</option>
      <option value="Egg Brade">Egg Brade</option>
    </select>
